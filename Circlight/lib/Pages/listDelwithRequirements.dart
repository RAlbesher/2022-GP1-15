...
//
  ...
  Future GetStudentName(snap) async {
    ...
    try {
      for (var i = 0; snap[i] != null; i++) {
        SnapCount += 1;
        if (snap[i]["isAccepted"] == "true" &&
            snap[i]["IsActive"] == "true" &&
            snap[i]["DelegatorActive"] == "true" &&
            snap[i]["ParentID"] == ParentId) {
          StudentID.add(snap[i]["StudentID"]);
          DDelegatorrID.add(snap[i]["DelegatorID"]);
        }
        if (snap[i]["isAccepted"] == "true" &&
            snap[i]["IsActive"] == "false" &&
            snap[i]["DelegatorActive"] == "true" &&
            snap[i]["ParentID"] == ParentId) {
          StudentID.add(snap[i]["StudentID"]);
          DDelegatorrID.add(snap[i]["DelegatorID"]);
  ...
  Future GetStudentName2(snap) async {
    ...
    try {
      for (var i = 0; snap[i] != null; i++) {
        ...
        RID = snap[i].reference.id;
        ShowRequest = false;
        //print("aaa");

        Accepted = snap[i]["isAccepted"];
        Active = snap[i]["IsActive"];
        DelegatorActive = snap[i]["DelegatorActive"];
        //  print("bbbbbb");
        if (Accepted == "true" &&
            DelegatorActive == "false" &&
            snap[i]["ParentID"] == ParentId) {
  ...
  Future GetStudentName3(snap) async {
    ...
    try {
      for (var i = 0; snap[i] != null; i++) {
        ...
        if (Accepted == "Waiting" && snap[i]["ParentID"] == ParentId) {
          StudentID.add(snap[i]["StudentID"]);
          DDelegatorrID.add(snap[i]["DelegatorID"]);
        }
  ...
  Future GetStudentName4(snap) async {
    ...
    try {
      for (var i = 0; snap[i] != null; i++) {
        ...
        if (Accepted != "Waiting" && snap[i]["ParentID"] == ParentId) {
          if (Accepted == "true" && snap[i]["ParentID"] == ParentId) {
            StudentID.add(snap[i]["StudentID"]);
            DDelegatorrID.add(snap[i]["DelegatorID"]);
          }
        }
  ...
  Future GetStudentName5(snap) async {
    ...
    try {
      for (var i = 0; snap[i] != null; i++) {
        Accepted = snap[i]["isAccepted"];
        if (Accepted != "Waiting" && snap[i]["ParentID"] == ParentId) {
          if (Accepted == "false" && snap[i]["ParentID"] == ParentId) {
            StudentID.add(snap[i]["StudentID"]);
            DDelegatorrID.add(snap[i]["DelegatorID"]);
          }
        }
