...
class AfternoonshiftAnnoun extends StatefulWidget {
  @override
  State<AfternoonshiftAnnoun> createState() => _AfternoonshiftAnnoun();
}

class _AfternoonshiftAnnoun extends State<AfternoonshiftAnnoun>
                      ...
                      child: Container(
                        ...
                        child: FittedBox(
                          child: FloatingActionButton(
                            onPressed: () {
                              //// هنا المفروووض احط الفووورم الجديد حق الاناونسمنت
                              Navigator.of(context).push(CupertinoPageRoute(
                                builder: (context) =>
                                    Nav_Afternoon(TabValue: 20),
                              ));
                            },
                            elevation: 0,
                            child: Container(
                        ...
                        child: FittedBox(
                          child: FloatingActionButton(
                            onPressed: () {
                              //// هنا المفروووض احط الفووورم الجديد حق الاناونسمنت
                              Navigator.of(context).push(CupertinoPageRoute(
                                builder: (context) => Nav(TabValue: 20),
                              ));
                            },
                            elevation: 0,
                            child: Container(
