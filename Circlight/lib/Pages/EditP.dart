...
class EditP extends StatefulWidget {
  ...
  @override
  State<EditP> createState() => _EditP();
  getData(change) {
    isChanged = change;
    print("in getData");
    print(isChanged);
...
class _EditP extends State<EditP> with TickerProviderStateMixin {
  int t = 0;
  int t2 = 0;
...
//for username uniqueness
  ...
  TextEditingController contPAltPhoneNumber = TextEditingController();
  ...
  void initState() {
    ...
    _icon2ColorTween = ColorTween(
      begin: Colors.white,
      end: const Color(0xFF29294D),
    ).animate(_ColorAnimationController);
                                ...
                                onPressed: () async {
                                  if (formKey.currentState!.validate()) {
                                    ...
                                    switch (Field) {
                                      ...
                                      case "AltPhoneNumber":
                                        UpdatedValue = contPAltPhoneNumber.text;
                                        break;
                                    }
        ...
        Fields = Directionality(
          ...
          child: Container(
            child: Align(
              ...
              child: TextFormField(
                maxLength: 10,
                controller: contPAltPhoneNumber..text = parentx.PAltPhoneNumber,
                //to take text from user input
                textAlign: TextAlign.right,
                ...
                validator: (value) {
                  if (OldValue != contPAltPhoneNumber.text) {
                    save = true;
                  }
                  ...
                  SingleChildScrollView(
                    child: Column(
                      ...
                      children: [
                        ...
                        Padding(
                          padding:
                              EdgeInsetsDirectional.fromSTEB(40, 20, 35, 16),
                          child: FFButtonWidget(
                            onPressed: () async {
                              showCupertinoDialog(
