...
class ListDelegatorr4 extends StatefulWidget {
  const ListDelegatorr4({Key? key}) : super(key: key);

  @override
  _Listt createState() => _Listt();
}

class _Listt extends State<ListDelegatorr4> with TickerProviderStateMixin {
  ...
  var SCount = 0;
  Stream<QuerySnapshot<Object?>> firebaseData =
...
//
  ...
  Future Requests2() async {
    await EmptyMethod2();
    Req2.get().then((snapshot) => snapshot.docs.forEach((document) {
          RID = document.reference.id;
          ShowRequest = false;
          print("aaa");
  ...
  Requests5() async {
    ...
    Req2.get().then((snapshot) => snapshot.docs.forEach((document) {
          ...
          if (Accepted != "Waiting") {
            ...
            } else if (Accepted == "true" && Empty5.isEmpty == true) {
              setState(() {
                NoResult5 = false;
              });
            } else if (Accepted == "Waiting" && Empty5.isEmpty == true) {
              setState(() {
                NoResult5 = false;
              });
            }
                    ...
                    StreamBuilder<QuerySnapshot>(
                      ...
                      builder: (BuildContext context,
                        ...
                        if (snapshot.hasData) {
                          ...
                          return FutureBuilder(
                            future: Future.wait(
                                [GetStudentName3(snap), Requests2()]),
                            builder: (context, snapshot) {
                              if (snapshot.data?.length != 0) {
                                //  Requests1();
                                Requests2();
                                                                    ...
                                                                    ? Padding(
                                                                        ...
                                                                        child:
                                                                          ...
                                                                          decoration:
                                                                              BoxDecoration(
                                                                            color:
                                                                                Color.fromARGB(107, 87, 215, 121).withOpacity(0.2),
                                                                            borderRadius:
                                                                          ...
                                                                          child: Text(
                                                                              "مقبوله",
                                                                              textAlign: TextAlign.center,
                                                                              style: TextStyle(fontSize: 11, fontWeight: FontWeight.w600, color: const Color(0xff57d77a))),
                                                                        ),
                                                                      )
                                                                    : Padding(
                                                                        padding: EdgeInsetsDirectional.fromSTEB(
                        ...
                        StreamBuilder<QuerySnapshot>(
                          ...
                          builder: (BuildContext context,
                            ...
                            if (snapshot.hasData) {
                              ...
                              return FutureBuilder(
                                future: Future.wait([GetStudentName5(snap)]),
                                builder: (context, snapshot) {
                                  if (snapshot.data?.length != 0 ||
