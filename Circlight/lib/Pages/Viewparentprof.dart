...
class Viewparentprof extends StatefulWidget {
  var isChanged = "";
  ...
  @override
  State<Viewparentprof> createState() => _Viewparentprof();
  getData(change) {
    isChanged = change;
  }
}

class _Viewparentprof extends State<Viewparentprof>
...
//for username uniqueness
  ...
  void initState() {
    ...
    scrollController = FixedExtentScrollController(initialItem: PIndex);
    controller = TextEditingController(text: Relation[PIndex]);
    Dvalue = parentx.PRelativeRelation;
    Dvalue2 = parentx.State;
  }
  ...
  Widget build(BuildContext context) {
    ...
    DropValue2 = List<String>.generate(10, growable: true, (index) => "null");
    DropValue[DropIndex] = "أم";
    DropValue2[DropIndex2] = "متاح";
    DropIndex += 1;
    DropIndex2 += 1;
...
//               // String pasword = sha1.convert(utf8.decode(pass));
//               var encoded = utf8.encode(pass);
// // var decoded = utf8.decode(encoded);
//               var passwordd = utf8.decode(encoded);
//                             var pasword = sha1.convert(passwordd);

              parentx.Password = data["Password"];

              DropValue2[DropIndex2] = data["State"];
              DropIndex2 += 1;
              if (t2 == 0) {
                Dvalue2 = data["State"];
              }
    ...
    switch (In) {
      ...
      case 9:
        ...
        Fields = Directionality(
          textDirection: TextDirection.rtl,
          child: TextFormField(
            controller: PPassword..text = parentx.Password,
            //to take text from user input
            textAlign: TextAlign.right,
                              ...
                              Container(
                                ...
                                child: CupertinoButton(
                                  ...
                                  onPressed: () async {
                                    ...
                                    await parentx.UpdateParent(
                                        widget.documentId, "State", Dvalue2);
                                  },
                                ),
                              ),
                              SizedBox(
