...
class ViewProfileParentAfternoonShift extends StatefulWidget {
  String documentId = "";

  ViewProfileParentAfternoonShift({
    Key? key,
    required this.documentId,
  }) : super(key: key);

  @override
  State<ViewProfileParentAfternoonShift> createState() =>
      _ViewProfileParentAfternoonShift();
}

class _ViewProfileParentAfternoonShift
    extends State<ViewProfileParentAfternoonShift>
