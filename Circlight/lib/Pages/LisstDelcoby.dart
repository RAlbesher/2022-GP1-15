...
class ListDelegatorr extends StatefulWidget {
  const ListDelegatorr({Key? key}) : super(key: key);

  @override
  _Listt createState() => _Listt();
}

class _Listt extends State<ListDelegatorr> with TickerProviderStateMixin {
                                                                    ...
                                                                    child:
                                                                      ...
                                                                      decoration:
                                                                        ...
                                                                        border:
                                                                            Border.all(
                                                                          color:
                                                                              Color.fromARGB(255, 79, 198, 111).withOpacity(0.2),
                                                                        ),
                                                                      ),
                                                                      child: Text(
                                                                          "مقبوله",
