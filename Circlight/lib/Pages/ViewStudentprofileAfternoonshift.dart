...
class ViewStudentProfileAfternoonshift extends StatefulWidget {
  ViewStudentProfileAfternoonshift({
    Key? key,
    required this.users,
  ...
  @override
  State<ViewStudentProfileAfternoonshift> createState() => _ViewStudentProfileAfternoonshift();
  getData(change) {
    //  isChanged = change;
  }
}

class _ViewStudentProfileAfternoonshift extends State<ViewStudentProfileAfternoonshift>
