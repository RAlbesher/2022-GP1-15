...
class RequestDoneAdmin extends StatefulWidget {
  String documentId;
  RequestDoneAdmin({
    Key? key,
...
class _PreviewReqParent extends State<RequestDoneAdmin> {
  ...
  Future GetStudentName4(snap) async {
    ...
    await Col2.doc(widget.documentId).get().then((document) async {
      try {
        ...
        var ID;
        await ColStudent.doc(document["StudentID"]).get().then((value) async {
        ...
        print(ID);
        Col.doc(ID).get().then((value) {
          print("3434343434345789");
          NameParent.text =
              "ID" + " " + value["NationalID"] + " " + "" + value["Name"];
          print(value["Name"]);
          print("++++++++++++++++++++++++");
